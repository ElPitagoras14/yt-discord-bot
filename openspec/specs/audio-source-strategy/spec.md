# audio-source-strategy Specification

## Purpose

Resolución de la estrategia de reproducción por canción (YouTube vs local), el contrato uniforme que todas las estrategias exponen hacia la cola, y la visibilización de la fuente de cada canción en `/queue`.
